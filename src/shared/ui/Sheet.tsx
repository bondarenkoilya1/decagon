...
export const SheetOverlay: FC<ComponentProps<typeof SheetPrimitive.Overlay>> = ({
  className,
  ...props
}) => {
  return (
...
export const SheetDescription: FC<ComponentProps<typeof SheetPrimitive.Description>> = ({
  className,
  ...props
}) => {
  return (
